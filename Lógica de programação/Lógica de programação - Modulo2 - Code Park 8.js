...
do {
  do {
    ...
    var finalizar = prompt(
      "Deseja finalizar a votação? (SIM | NÃO):"
    ).toUpperCase();
  } while (finalizar !== "SIM");
...
Vostos por Candidatos:
  ...
  if (
    qtdVotosCandidato01 > qtdVotosCandidato02 &&
    qtdVotosCandidato01 > qtdVotosCandidato03
  ) {
    alert(`${CANDIDATOS.candidato01Nome} venceu a eleição!`);
  } else if (
    qtdVotosCandidato02 > qtdVotosCandidato01 &&
    qtdVotosCandidato02 > qtdVotosCandidato03
  ) {
    alert(`${CANDIDATOS.candidato02Nome} venceu a eleição!`);
  } else if (
    qtdVotosCandidato03 > qtdVotosCandidato01 &&
    qtdVotosCandidato03 > qtdVotosCandidato02
  ) {
